...
if __name__ == "__main__":
    ...
    for epoch in range(1, MAX_EPOCHS + 1):
        ...
        if val_loss < best_val_loss:
            ...
            epochs_without_improvement = 0
            torch.save(model.state_dict(), ensure_parent_dir(artifact_path("models", "spectranet_v3.pt")))
        else:
    ...
    model.load_state_dict(torch.load(artifact_path("models", "spectranet_v3.pt"), weights_only=True))
    ...
    fig.tight_layout()
    out_path = ensure_parent_dir(artifact_path("figures", "loss_curve_v3.png"))
    ...
    fig.suptitle("SpectraNet V3 — Predicted vs True (Test Set)", fontsize=13,
                 y=1.02)
    fig.tight_layout()
    out_path = ensure_parent_dir(artifact_path("figures", "parity_plot_v3.png"))
